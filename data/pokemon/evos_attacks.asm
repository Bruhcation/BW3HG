...
ScolipedeEvosAttacks:
	...
	db 28, VENOSHOCK
	db 33, AGILITY
	db 36, X_SCISSOR ; Steamroller
	db 40, CROSS_POISON ; Venom Drench
	db 44, TOXIC
	db 48, EXTREMESPEED ; Rock Climb
	db 52, DOUBLE_EDGE
	db 56, MEGAHORN
	db 0 ; no more level-up moves
...
SeismitoadEvosAttacks:
	...
	db 35, ACID
	db 37, FLAIL
	db 39, EARTH_POWER ; Echoed Voice
	db 42, DRAIN_PUNCH
	db 36, HYDRO_PUMP
	db 50, HYPER_VOICE
	db 0 ; no more level-up moves
...
ClefairyEvosAttacks:
	...
	db 39, BODY_SLAM
	db 41, MOONLIGHT
	db 44, AMNESIA ; Gravity
	db 47, METEOR_MASH
	db 50, RECOVER ; Healing Wish
	db 0 ; no more level-up moves
...
MusharnaEvosAttacks:
	...
	db 19, HYPNOSIS
	db 23, ZEN_HEADBUTT
	db 30, EXTRASENSORY ; Synchronoise
	db 33, MIRROR_COAT ; Future Sight
	db 35, CALM_MIND
	db 37, PSYCHIC_M
	db 41, DREAM_EATER
	db 0 ; no more level-up moves
...
BraviaryEvosAttacks:
	...
	db 28, DRILL_PECK ; Slash
	db 32, DOUBLE_TEAM ; Defog
	db 35, AGILITY ; Tailwind
	db 38, BODY_SLAM ; Crush Claw
	db 41, ACROBATICS ; Sky Drop
	db 44, CLOSE_COMBAT ; Superpower
	db 47, WHIRLWIND
	db 50, BRAVE_BIRD
	db 0 ; no more level-up moves

VullabyEvosAttacks:
	db EVOLVE_LEVEL, 36, MANDIBUZZ
	db 0 ; no more evolutions
	db 1, GUST
	db 1, LEER
	db 5, FURY_ATTACK
...
BlitzleEvosAttacks:
	...
	db 11, SHOCK_WAVE
	db 14, THUNDER_WAVE
	db 17, FLAME_WHEEL ; Flame Charge
	db 21, PURSUIT
	db 24, SPARK
...
GranbullEvosAttacks:
	...
	db 19, HEADBUTT
	db 27, ROAR
	db 30, DIZZY_PUNCH ; Rage
	db 36, PLAY_ROUGH
	db 40, IRON_TAIL ; Payback
	db 44, CRUNCH
	db 49, OUTRAGE
	db 0 ; no more level-up moves
...
LucarioEvosAttacks:
	...
	db 28, MACH_PUNCH ; Bone Rush
	db 32, BULK_UP ; Quick Guard
	db 36, BULLET_PUNCH ; Me First
	db 40, DRAIN_PUNCH ; Me First
	db 42, IRON_HEAD ; Work Up
	db 46, CALM_MIND
	db 50, CLOSE_COMBAT
	db 52, RECOVER ; Heal Pulse
	db 55, DRAGON_PULSE
	db 55, EXTREMESPEED
	db 0 ; no more level-up moves

TimburrEvosAttacks:
	db EVOLVE_LEVEL, 21, GURDURR
	db 0 ; no more evolutions
	db 1, TACKLE ; Pound
	db 1, LEER
	db 4, FOCUS_ENERGY
...
CrustleEvosAttacks:
	...
	db 31, SLASH
	db 35, X_SCISSOR
	db 40, SWORDS_DANCE ; Shell Smash
	db 45, FLAIL
	db 50, STONE_EDGE ; Rock Wrecker
	db 0 ; no more level-up moves
...
DrifblimEvosAttacks:
	...
	db 36, SHADOW_BALL
	db 39, AMNESIA
	db 42, HURRICANE ; Phantom Force
	db 45, PAIN_SPLIT ; Baton Pass
	db 48, EXPLOSION
	db 0 ; no more level-up moves

MedititeEvosAttacks:
	db EVOLVE_LEVEL, 33, MEDICHAM
	db 0 ; no more evolutions
...
HoundourEvosAttacks:
	...
	db 13, ROAR
	db 16, BITE
	db 19, FORESIGHT ; Odor Sleuth
	db 22, FIRE_FANG	
	db 24, FAINT_ATTACK ; Beat Up
	db 28, FIRE_FANG
...
HoundoomEvosAttacks:
	...
	db 30, FIRE_FANG
	db 33, SUCKER_PUNCH ; Faint Attack
	db 36, CRUNCH ; Embargo
	; Skipped Foul Play
	db 39, FLAMETHROWER
	db 41, DARK_PULSE ; Crunch
	db 46, NASTY_PLOT
	db 51, OVERHEAT ; Inferno
	db 0 ; no more level-up moves
...
YanmegaEvosAttacks:
	...
	db 30, SIGNAL_BEAM ; Pursuit
	db 33, ANCIENTPOWER
	db 36, HYPNOSIS ; Feint
	db 38, AIR_SLASH
	db 41, BUG_BUZZ
	db 43, SLASH
	db 45, X_SCISSOR ; U-turn
	db 0 ; no more level-up moves
...
BreloomEvosAttacks:
	...
	db 36, DRAIN_PUNCH ; Sky Uppercut
	db 40, SEED_BOMB
	db 50, DYNAMICPUNCH
	db 60, SPORE
	db 0 ; no more level-up moves
...
ZoroarkEvosAttacks:
	...
	db 37, DARK_PULSE ; Punishment
	db 40, AGILITY
	db 44, CONFUSE_RAY ; Embargo
	db 47, NASTY_PLOT
	; Skipped Imprison
	db 50, FOCUS_BLAST ; Night Daze
	db 0 ; no more level-up moves

TrubbishEvosAttacks:
	db EVOLVE_LEVEL, 32, GARBODOR
	db 0 ; no more evolutions
	db 1, TACKLE ; Pound
	db 1, POISON_GAS
...
MagnemiteEvosAttacks:
	...
	db 28, IRON_DEFENSE ; Metal Sound
	db 31, FLASH_CANNON
	db 35, SCREECH
	db 37, DISCHARGE
	db 41, LOCK_ON
...
MagnetonEvosAttacks:
	...
	db 39, SCREECH
	db 42, LOCK_ON
	db 45, REFLECT ; Magnet Rise
	db 48, IRON_HEAD ; Gyro Ball
	db 52, ZAP_CANNON
	db 0 ; no more level-up moves
...
GothitelleEvosAttacks:
	...
	db 40, DAZZLINGLEAM ; Telekinesis
	db 43, CHARM
	db 46, BARRIER ; Magic Room
	db 0 ; no more level-up moves

SolosisEvosAttacks:
	db EVOLVE_LEVEL, 22, DUOSION
	db 0 ; no more evolutions
	db 1, CONFUSION ; Psywave
	db 3, REFLECT
	db 7, ROLLOUT
...
ReuniclusEvosAttacks:
	...
	db 37, PSYCHIC_M
	db 39, DIZZY_PUNCH
	db 42, HYPNOSIS ; Skill Swap
	db 45, BARRIER ; Heal Block
	db 49, DREAM_EATER ; Wonder Room
	db 0 ; no more level-up moves
...
SawsbuckEvosAttacks:
	...
	db 28, SYNTHESIS ; Aromatherapy
	db 32, ENERGY_BALL
	db 34, MEGAHORN ; Horn Leech
	db 36, SEED_BOMB
	db 36, CHARM
	db 42, WOOD_HAMMER ; Nature Power
	db 46, DOUBLE_EDGE
	db 50, SOLARBEAM
	db 0 ; no more level-up moves
...
AccelgorEvosAttacks:
	...
	db 54, AURA_SPHERE ; Final Gambit
	db 0 ; no more level-up moves
...
DrapionEvosAttacks:
	...
	db 27, VENOSHOCK
	db 30, HONE_CLAWS
	db 33, TOXIC ; Toxic Spikes
	db 37, NIGHT_SLASH
	db 41, CROSS_POISON
	db 45, CRUNCH
	db 48, X_SCISSOR ; Fell Stinger
	db 0 ; no more level-up moves

TrapinchEvosAttacks:
	db EVOLVE_LEVEL, 32, VIBRAVA
	db 0 ; no more evolutions
	db 1, BITE
	db 1, SAND_ATTACK
	db 1, FAINT_ATTACK
...
ScraftyEvosAttacks:
	...
	db 34, SCARY_FACE
	db 38, CRUNCH
	db 41, BODY_SLAM ; Facade
	db 45, FLAIL ; Rock Climb
	db 48, CROSS_CHOP ; Focus Punch
	db 53, STONE_EDGE ; Head Smash
	db 0 ; no more level-up moves
...
CameruptEvosAttacks:
	...
	db 33, ROCK_SLIDE
	db 33, EARTHQUAKE
	db 36, FLAMETHROWER ; Eruption
	db 39, REST ; Yawn
	db 42, FLARE_BLITZ ; Fissure
	db 0 ; no more level-up moves
...
GligarEvosAttacks:
	...
	db 19, FAINT_ATTACK
	db 22, ACROBATICS
	db 25, MAGNITUDE ; U-turn
	db 27, SLASH
	db 30, SCREECH
	db 35, EARTHQUAKE ; Guillotine
	db 40, X_SCISSOR
...
SigilyphEvosAttacks:
	...
	db 33, AGILITY ; Mirror Move
	db 36, AIR_SLASH
	db 41, BARRIER ; Gravity
	db 44, PSYCHIC_M
...
TirtougaEvosAttacks:
	...
	db 28, ROCK_TOMB ; Smack Down
	db 33, AQUA_TAIL
	db 35, CURSE
	db 37, ROCK_SLIDE
	db 39, BELLY_DRUM ; Shell Smash
	db 45, RAIN_DANCE
	db 50, HYDRO_PUMP
	db 0 ; no more level-up moves
...
ArcheopsEvosAttacks:
	...
	db 42, BRAVE_BIRD ; U-turn
	db 45, ROCK_SLIDE
	db 50, OUTRAGE ; Thrash
	db 0 ; no more level-up moves

FrillishEvosAttacks:
	db EVOLVE_LEVEL, 35, JELLICENT
	db 0 ; no more evolutions
	db 1, BUBBLE
	db 5, ABSORB
	db 9, NIGHT_SHADE
	...
	db 32, SCALD ; Brine
	db 35, RAIN_DANCE
	db 37, SHADOW_BALL ; Hex
	db 45, HYDRO_PUMP
	db 50, GIGA_DRAIN ; Wring Out
	db 0 ; no more level-up moves
...
EmolgaEvosAttacks:
	...
	db 16, PURSUIT
	db 19, SHOCK_WAVE
	db 22, AIR_SLASH ; Electro Ball
	db 26, DOUBLE_TEAM 
	db 30, ACROBATICS
	db 34, LIGHT_SCREEN
	db 36, DISCHARGE ; Volt Switch
	db 39, ENCORE
	db 42, THUNDERBOLT
	db 46, AGILITY
...
FlareonEvosAttacks:
	...
	db 27, FIRE_FANG
	db 29, SCARY_FACE
	db 33, SLUDGE_BOMB ; Smog
	db 37, LAVA_PLUME
	db 41, FLARE_BLITZ 
	db 45, GIGA_IMPACT ; Last Resort
	db 0 ; no more level-up moves
...
EspeonEvosAttacks:
	...
	db 27, EXTRASENSORY ; Future Sight
	db 29, PSYCH_UP
...
CroagunkEvosAttacks:
	...
	db 19, FAINT_ATTACK
	db 24, SWAGGER
	db 28, MUD_SHOT ; Mud Bomb
	db 31, DRAIN_PUNCH ; Sucker Punch
	db 33, CROSS_POISON ; Poison Jab
	db 36, SUCKER_PUNCH ; Venoshock
	db 38, NASTY_PLOT
	db 43, GUNK_SHOT ; Poison Jab
	db 45, SLUDGE_BOMB
	db 0 ; no more level-up moves
...
HeatmorEvosAttacks:
	...
	db 16, FIRE_SPIN
	db 21, FURY_SWIPES
	db 24, FIRE_PUNCH ; Fire Lash
	db 26, HONE_CLAWS ; Snatch
	db 31, LAVA_PLUME ; Flame Burst
	db 33, BUG_BITE
	db 36, FLAMETHROWER
	db 41, SLASH
	db 43, CURSE ; Stockpile/Swallow/Spit Up
	db 47, AMNESIA
	db 50, FLARE_BLITZ
	db 53, OVERHEAT ; Inferno
	db 0 ; no more level-up moves
...
DurantEvosAttacks:
	...
	db 26, IRON_HEAD
	db 31, DIG
	db 33, MINIMIZE ; Entrainment
	db 36, X_SCISSOR
	db 40, METEOR_MASH ; Guillotine
	db 43, IRON_DEFENSE
	db 46, SCREECH ; Metal Sound
	db 0 ; no more level-up moves
...
TropiusEvosAttacks:
	...
	db 36, AIR_SLASH
	db 38, BODY_SLAM
	db 40, DOUBLE_EDGE ; Bestow
	db 43, SYNTHESIS
	db 46, SOLARBEAM
	db 50, WOOD_HAMMER ; Leaf Storm
	db 0 ; no more level-up moves

PawniardEvosAttacks:
	db EVOLVE_LEVEL, 36, BISHARP
	db 0 ; no more evolutions
	db 1, SCRATCH
	db 6, LEER
	db 9, FURY_CUTTER
...
AxewEvosAttacks:
	...
	db 41, DRAGON_PULSE
	db 43, SWORDS_DANCE
	db 47, BELLY_DRUM ; Guillotine
	db 50, OUTRAGE
	db 55, GIGA_IMPACT
	db 0 ; no more level-up moves

FraxureEvosAttacks:
	db EVOLVE_LEVEL, 42, HAXORUS
	db 0 ; no more evolutions
	db 1, SCRATCH
	db 4, LEER
	db 7, PURSUIT ; Assurance
...
CorphishEvosAttacks:
	...
	db 26, NIGHT_SLASH
	db 29, AQUA_JET ; Razor Shell
	db 31, SWAGGER ; Taunt
	db 33, SWORDS_DANCE
	db 36, CRUNCH
	db 39, AQUA_TAIL ; Crabhammer
	db 43, DRAGON_DANCE ; Guillotine
	db 0 ; no more level-up moves
...
LarvitarEvosAttacks:
	...
	db 19, ROCK_SLIDE
	db 23, SCARY_FACE
	db 26, MAGNITUDE ; Payback
	db 29, DOUBLE_EDGE ; Thrash
	db 32, DARK_PULSE
	db 36, CRUNCH
	db 40, EARTHQUAKE
	db 45, STONE_EDGE
...
VolcaronaEvosAttacks:
	...
	db 40, WHIRLWIND
	db 40, BUG_BUZZ
	db 40, LAVA_PLUME ; Heat Wave
	; Skipped Silver Wind
	db 45, FLAMETHROWER
	db 50, QUIVER_DANCE
	; Skipped Rage Powder
	db 55, HURRICANE
	db 60, OVERHEAT ; Fiery Dance
	db 0 ; no more level-up moves

TynamoEvosAttacks:
	db EVOLVE_LEVEL, 29, EELEKTRIK
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, THUNDER_WAVE
	db 1, SPARK
...
WalreinEvosAttacks:
	...
	db 43, ICE_FANG
	db 46, BLIZZARD
	db 50, BELLY_DRUM ; Sheer Cold
	db 0 ; no more level-up moves

SnoruntEvosAttacks:
	db EVOLVE_LEVEL, 36, GLALIE
...
StunfiskEvosAttacks:
	...
	db 25, DISCHARGE
	db 28, ENDURE
	db 30, ACROBATICS ; Bounce
	db 33, EARTH_POWER ; Muddy Water
	db 36, THUNDERBOLT
	db 40, COUNTER ; Revenge
	db 42, FLAIL
	db 45, EARTHQUAKE ; Fissure
	db 0 ; no more level-up moves
...
DragonairEvosAttacks:
	...
	db 35, AQUA_TAIL
	db 40, DRAGON_DANCE
	db 45, DRAGON_PULSE ; Dragon Rush
	db 50, SAFEGUARD
	db 55, OUTRAGE
	db 75, HYPER_BEAM
	db 0 ; no more level-up moves
...
DeinoEvosAttacks:
	...
	db 28, BODY_SLAM ; Slam
	db 32, DRAGON_PULSE
	db 36, DRAGON_CLAW ; Dragon Rush
	db 39, HONE_CLAWS ; Work Up
