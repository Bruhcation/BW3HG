...
; entries correspond to constants/move_constants.asm
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         40, GRASS, PHYSICAL,    100, 15,   0
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          75, GRASS, SPECIAL,     100, 15,   0
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC, SPECIAL,   70,  5, 100
	...
	move ICICLE_CRASH, EFFECT_FLINCH_HIT,         90, ICE, PHYSICAL,       95, 10,  30
	...
	move CROSS_POISON, EFFECT_POISON_HIT,         75, POISON, PHYSICAL,   100, 20,  10
	move GUNK_SHOT,    EFFECT_POISON_HIT,        120, POISON, PHYSICAL,    85, 10,  30
	...
	move HAMMER_ARM,   EFFECT_HAMMER_ARM,        100, FIGHTING, PHYSICAL,  90, 15,   0
	move CLOSE_COMBAT, EFFECT_CLOSE_COMBAT,      120, FIGHTING, PHYSICAL, 100, 10,   0
	...
	move FOCUS_BLAST,  EFFECT_SP_DEF_DOWN_HIT,   120, FIGHTING, SPECIAL,   70, 10,  10
	...
	move PSYCHO_CUT,   EFFECT_NORMAL_HIT,         75, PSYCHIC, PHYSICAL,  100, 20,   0
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         85, PSYCHIC, PHYSICAL,   90, 15,  20
	...
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC, SPECIAL,   100, 15,  10
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  30, GROUND, SPECIAL,    100, 10, 100
	...
	move FLASH_CANNON, EFFECT_SP_DEF_DOWN_HIT,    85, STEEL, SPECIAL,     100, 10,  10
	...
	move DRAININGKISS, EFFECT_LEECH_HIT,          60, FAIRY, SPECIAL,     100, 10,   0
	...
	move CUT,          EFFECT_NORMAL_HIT,         55, BUG,    PHYSICAL,    95, 30,   0
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          18, NORMAL, PHYSICAL,   100, 10,   0
